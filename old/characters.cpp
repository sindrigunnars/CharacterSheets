...
// template <class T> Roles<T>::Roles() {
...
// }
// template <class T> 
// void Roles<T>::add_character(std::string role) {
...
// template <class T> 
// void Roles<T>::deleteRole(std::string name) {
...
// template <class T> 
// void Roles<T>::print_role_detailed(std::string name) {
//     cout << name << ": " << endl;
//     for(const auto& elem : roles){
...
// template <class T> 
// void Roles<T>::print_roster_to_file() {
